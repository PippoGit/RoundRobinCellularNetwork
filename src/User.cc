...
void User::handleFrame(Frame* f)
{
    ...
    emit(served_s, (int) !(res.last_seen < 0)); // se non sono stato servito emitto 0 perch̬ lastSeen varrebbe -1. altrimenti emitto 1 che vuol dire somma 1 al contatore
